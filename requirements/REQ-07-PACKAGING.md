...
- 07.04.007: The Claude Code plugin MUST include a `pull-and-review` skill that defines the Copilot pull-request review loop for opening PRs, waiting for review comments, addressing valid feedback, resolving addressed threads, re-requesting review, and reporting disputed unresolved comments.
