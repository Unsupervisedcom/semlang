...
- 07.04.007: The Claude Code plugin MUST include an `initial-ontology-creation` skill that guides downstream users through creating an initial SemLang ontology.
